...
public class ItfaiyeEkrani extends javax.swing.JFrame {

    public ItfaiyeEkrani() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("İtfaiye Kurumu");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        jLabel1.setText("İtfaiye Kurumu'na eriştiniz. Lütfen bilgilerinizi doğru bir şekilde giriniz.");

        jLabel2.setFont(new java.awt.Font("Century", 1, 24)); // NOI18N
        jLabel2.setText("İtfaiye Kurumu");
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    ...
                    .addGap(18, 18, 18)
                    .addComponent(bilgilerimiKaydetButton, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addContainerGap(77, Short.MAX_VALUE)))
        );
    ...
    private void bilgilerimiKaydetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bilgilerimiKaydetButtonActionPerformed
        Itfaiye i= new Itfaiye(adText.getText(), soyadText.getText(), ilText.getText(), "İtfaiye");
        ...
        i.dosyaEkle();
        i.veriEkle();
        String mesaj="Bilgileriniz kaydedildi. Ekiplerimiz tahmini "+i.sure()+" dakika sonra olay yerinde olacaktır.";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ItfaiyeEkrani().setVisible(true);
            }
        });
    }
