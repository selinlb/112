...
public class OrmanEkrani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Orman Kurumu");

        jLabel2.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        jLabel2.setText("Orman Kurumu'na eriştiniz. Lütfen bilgilerinizi doğru bir şekilde giriniz.");
    ...
    private void bilgilerimiKaydetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bilgilerimiKaydetButtonActionPerformed
        Orman o= new Orman(adText.getText(), soyadText.getText(), ilText.getText(), "Orman");
        adText.setText("");
        soyadText.setText("");
        ilText.setText("");
        ...
        o.dosyaEkle();
        o.veriEkle();
        String mesaj="Bilgileriniz kaydedildi. Ekiplerimiz tahmini "+o.sure()+" dakika sonra olay yerinde olacaktır.";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OrmanEkrani().setVisible(true);
            }
        });
    }
