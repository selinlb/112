...
public class PolisEkrani extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Polis Kurumu");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Century", 1, 24)); // NOI18N
        jLabel1.setText("Polis Kurumu");

        jLabel2.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        jLabel2.setText("Polis Kurumu'na eriştiniz. Lütfen bilgilerinizi doğru bir şekilde giriniz.");
    ...
    private void bilgilerimiKaydetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bilgilerimiKaydetButtonActionPerformed
        Polis p= new Polis(adText.getText(), soyadText.getText(), ilText.getText(), "Polis");
        adText.setText("");
        soyadText.setText("");
        ilText.setText("");
        ...
        p.dosyaEkle();
        p.veriEkle();
        String mesaj="Bilgileriniz kaydedildi. Ekiplerimiz tahmini "+p.sure()+" dakika sonra olay yerinde olacaktır.";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PolisEkrani().setVisible(true);
            }
        });
    }
