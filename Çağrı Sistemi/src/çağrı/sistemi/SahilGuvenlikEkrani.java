...
public class SahilGuvenlikEkrani extends javax.swing.JFrame {
   
    public SahilGuvenlikEkrani() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Sahil Güvenlik Kurumu");

        jPanel1.setBackground(new java.awt.Color(255, 255, 255));

        jLabel1.setFont(new java.awt.Font("Century", 1, 24)); // NOI18N
        jLabel1.setText("Sahil Güvenlik Kurumu");

        jLabel2.setFont(new java.awt.Font("Century", 0, 14)); // NOI18N
        jLabel2.setText("Sahil Güvenlik Kurumu'na eriştiniz. Lütfen bilgilerinizi doğru bir şekilde giriniz.");
    ...
    private void bilgilerimiKaydetButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bilgilerimiKaydetButtonActionPerformed
        SahilGuvenlik sg= new SahilGuvenlik(adText.getText(), soyadText.getText(), ilText.getText(), "Sahil Güvenlik");
        adText.setText("");
        soyadText.setText("");
        ilText.setText("");
        ...
        sg.dosyaEkle();
        sg.veriEkle();
        String mesaj="Bilgileriniz kaydedildi. Ekiplerimiz tahmini "+sg.sure()+" dakika sonra olay yerinde olacaktır.";
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SahilGuvenlikEkrani().setVisible(true);
            }
        });
    }
